...
namespace API_NganLuong
{
    public class nganluongInfo
    {
        ...
        public static readonly string return_url = "http://222.255.46.4:3000/confirm-orderPaymentOnline";
        // dường dẫn khi thanh tán thất bại
        public static readonly string cancel_url = "http://222.255.46.4:3000/cancel-order";
